...
var $author$project$Joke$Any = {$: 'Any'};
var $author$project$Main$Model = F3(
	function (title, mJoke, category) {
		return {category: category, mJoke: mJoke, title: title};
	});
var $author$project$Main$Got = function (a) {
	return {$: 'Got', a: a};
};
var $author$project$Joke$categoryToString = function (category) {
	switch (category.$) {
		case 'Programming':
			return 'programming';
		case 'Miscellaneous':
...
var $author$project$Joke$Joke = F3(
	function (category, body, id) {
		return {body: body, category: category, id: id};
	});
var $author$project$Joke$Single = function (a) {
	return {$: 'Single', a: a};
};
var $author$project$Joke$TwoParts = F2(
	function (a, b) {
		return {$: 'TwoParts', a: a, b: b};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $elm$core$String$toLower = _String_toLower;
var $author$project$Joke$bodyDecoder = A2(
				...
				return A2(
					...
					function (joke) {
						return $elm$json$Json$Decode$succeed(
							$author$project$Joke$Single(joke));
					},
				...
				return A2(
					...
					function (setup) {
						return A2(
							...
							function (delivery) {
								return $elm$json$Json$Decode$succeed(
									A2($author$project$Joke$TwoParts, setup, delivery));
							},
	...
	A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string));
var $author$project$Joke$Dark = {$: 'Dark'};
var $author$project$Joke$Miscellaneous = {$: 'Miscellaneous'};
var $author$project$Joke$Programming = {$: 'Programming'};
var $author$project$Joke$categoryDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
		var _v0 = $elm$core$String$toLower(str);
		switch (_v0) {
			case 'programming':
				return $elm$json$Json$Decode$succeed($author$project$Joke$Programming);
			case 'miscellaneous':
				return $elm$json$Json$Decode$succeed($author$project$Joke$Miscellaneous);
			case 'dark':
				return $elm$json$Json$Decode$succeed($author$project$Joke$Dark);
			case 'any':
				return $elm$json$Json$Decode$succeed($author$project$Joke$Any);
			default:
				var somethingElse = _v0;
				return $elm$json$Json$Decode$fail('Unknown category: ' + somethingElse);
		}
	},
	$elm$json$Json$Decode$string);
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Joke$decoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Joke$Joke,
	A2($elm$json$Json$Decode$field, 'category', $author$project$Joke$categoryDecoder),
	$author$project$Joke$bodyDecoder,
...
var $author$project$Main$get = function (category) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$Got, $author$project$Joke$decoder),
			url: 'https://sv443.net/jokeapi/category/' + $author$project$Joke$categoryToString(category)
		});
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Main$Model, 'Elm Jokes', $elm$core$Maybe$Nothing, $author$project$Joke$Any),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Main$get($author$project$Joke$Any)
				])));
};
	...
	function (msg, model) {
		...
		switch (msg.$) {
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								mJoke: $elm$core$Maybe$Just(joke)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
			...
			case 'KeyPress':
				...
				return _Utils_Tuple2(
					model,
					(key === ' ') ? $author$project$Main$get(category) : $elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$viewJokeBody = function (body) {
	if (body.$ === 'Single') {
		var joke = body.a;
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('single')
				]),
			_List_fromArray(
				[
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('twopart ')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(delivery)
						]))
				]));
	}
};
var $author$project$Main$viewJoke = function (_v0) {
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Joke$categoryToString(category))
					])),
				$author$project$Main$viewJokeBody(body)
			]));
};
...
var $author$project$Main$viewRadioFor = F2(
	function (current, cat) {
		var selected = _Utils_eq(current, cat);
		var id = $author$project$Joke$categoryToString(cat);
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							function (_v0) {
								return $author$project$Main$Set(cat);
							})
						]),
					_List_Nil),
					A2(
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$Main$viewRadioFor, category, $author$project$Joke$Any),
						A2($author$project$Main$viewRadioFor, category, $author$project$Joke$Dark),
						A2($author$project$Main$viewRadioFor, category, $author$project$Joke$Programming),
						A2($author$project$Main$viewRadioFor, category, $author$project$Joke$Miscellaneous)
					])),
				A2(
				$elm$html$Html$main_,
				_List_Nil,
				_List_fromArray(
					[
						...
						if (mJoke.$ === 'Just') {
							var joke = mJoke.a;
							return $author$project$Main$viewJoke(joke);
						} else {
							return $elm$html$Html$text('');
						}
					}()
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Joke.Joke":{"args":[],"type":"{ category : Joke.Category, body : Joke.Body, id : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Got":["Result.Result Http.Error Joke.Joke"],"KeyPress":["String.String"],"Set":["Joke.Category"]}},"Joke.Body":{"args":[],"tags":{"Single":["String.String"],"TwoParts":["String.String","String.String"]}},"Joke.Category":{"args":[],"tags":{"Programming":[],"Miscellaneous":[],"Dark":[],"Any":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));