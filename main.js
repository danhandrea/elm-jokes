...
var $author$project$Main$Model = F2(
	function (title, mJoke) {
		return {mJoke: mJoke, title: title};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$Main$Model, 'Elm Jokes', $elm$core$Maybe$Nothing),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'Got') {
			...
			return _Utils_Tuple2(
				model,
				(key === ' ') ? $author$project$Main$get($author$project$Joke$Any) : $elm$core$Platform$Cmd$none);
		}
	});
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Joke.Joke":{"args":[],"type":"{ category : Joke.Category, body : Joke.Body, id : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Got":["Result.Result Http.Error Joke.Joke"],"KeyPress":["String.String"]}},"Joke.Body":{"args":[],"tags":{"Single":["String.String"],"TwoParts":["String.String","String.String"]}},"Joke.Category":{"args":[],"tags":{"Programming":[],"Miscellaneous":[],"Dark":[],"Any":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));