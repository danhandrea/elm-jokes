...
var $author$project$Joke$Any = 3;
var $author$project$Main$Model = F3(
	function (title, mJoke, category) {
		return {at: category, G: mJoke, N: title};
	});
...
var $author$project$Joke$Joke = F3(
	function (category, body, id) {
		return {as: body, at: category, az: id};
	});
...
var $author$project$Joke$Dark = 2;
var $author$project$Joke$Miscellaneous = 1;
var $author$project$Joke$Programming = 0;
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aq: false, as: r.as, aw: r.aw, U: r.U, aC: r.aC, aN: r.aN, an: r.an, aP: r.aP}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{as: $elm$http$Http$emptyBody, aw: r.aw, U: _List_Nil, aC: 'GET', aN: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing, aP: r.aP});
};
var $author$project$Main$get = function (category) {
	return $elm$http$Http$get(
		{
			aw: A2($elm$http$Http$expectJson, $author$project$Main$Got, $author$project$Joke$decoder),
			aP: 'https://sv443.net/jokeapi/category/' + $author$project$Joke$categoryToString(category)
		});
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Main$Model, 'Elm Jokes', $elm$core$Maybe$Nothing, 3),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Main$get(3)
				])));
};
	...
	return {
		as: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$Main$viewRadioFor, category, 3),
						A2($author$project$Main$viewRadioFor, category, 2),
						A2($author$project$Main$viewRadioFor, category, 0),
						A2($author$project$Main$viewRadioFor, category, 1)
					])),
				A2(
				$elm$html$Html$main_,
				_List_Nil,
